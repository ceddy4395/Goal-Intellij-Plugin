...
import nl.tudelft.intelligoal.core.language.actionspec.grammer.psi.iface.ActionSpecUseClause;
...
public class ActionSpecUseClauseImpl extends ASTWrapperPsiElement implements ActionSpecUseClause {

  public ActionSpecUseClauseImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ActionSpecFileReference getFileReference() {
    return findChildByClass(ActionSpecFileReference.class);
  }

  @Override
  @Nullable
  public ActionSpecUsage getUsage() {
    return findChildByClass(ActionSpecUsage.class);
  }
