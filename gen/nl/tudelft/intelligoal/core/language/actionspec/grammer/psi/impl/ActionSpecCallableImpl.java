...
public class ActionSpecCallableImpl extends ASTWrapperPsiElement implements ActionSpecCallable {

  public ActionSpecCallableImpl(ASTNode node) {
    super(node);
  }
  ...
  public ActionSpecIdentifier getIdentifier() {
    return findNotNullChildByClass(ActionSpecIdentifier.class);
  }
