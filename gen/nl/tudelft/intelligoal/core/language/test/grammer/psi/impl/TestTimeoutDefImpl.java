...
import nl.tudelft.intelligoal.core.language.test.grammer.psi.iface.TestTimeoutDef;
...
public class TestTimeoutDefImpl extends ASTWrapperPsiElement implements TestTimeoutDef {

  public TestTimeoutDefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TestVisitor visitor) {
    visitor.visitTimeoutDef(this);
  }
