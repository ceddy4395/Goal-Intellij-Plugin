...
public class GoalInstructionImpl extends ASTWrapperPsiElement implements GoalInstruction {

  public GoalInstructionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GoalConstraintList getConstraintList() {
    return findChildByClass(GoalConstraintList.class);
  }
