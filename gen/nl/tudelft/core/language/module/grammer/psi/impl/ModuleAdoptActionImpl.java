...
public class ModuleAdoptActionImpl extends ASTWrapperPsiElement implements ModuleAdoptAction {

  public ModuleAdoptActionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ModuleVisitor visitor) {
    visitor.visitAdoptAction(this);
  }
