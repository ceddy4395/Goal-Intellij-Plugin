package nl.tudelft.intelligoal.core.language.actionspec;
...
import nl.tudelft.intelligoal.core.language.actionspec.grammer.ActionSpecLexerAdapter;
 ...
 */
public class ActionSpecSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    static {
        MAP.put(ActionSpecTypes.USE, KEYWORDS);
        MAP.put(ActionSpecTypes.AS, KEYWORDS);
        MAP.put(ActionSpecTypes.KNOWLEDGE, KEYWORDS);
        MAP.put(ActionSpecTypes.DEFINE, KEYWORDS);
        MAP.put(ActionSpecTypes.WITH, KEYWORDS);
        MAP.put(ActionSpecTypes.PRE, KEYWORDS);
        MAP.put(ActionSpecTypes.POST, KEYWORDS);
        MAP.put(ActionSpecTypes.NOT, KEYWORDS);
        MAP.put(ActionSpecTypes.TRUE, KEYWORDS);
        MAP.put(ActionSpecTypes.IS, KEYWORDS);

        MAP.put(ActionSpecTypes.STRING, STRINGS);
        MAP.put(ActionSpecTypes.SQSTRING, STRINGS);
        MAP.put(ActionSpecTypes.DQSTRING, STRINGS);

        MAP.put(ActionSpecTypes.NUMBER, NUMBERS);
        MAP.put(ActionSpecTypes.REAL, NUMBERS);
        MAP.put(ActionSpecTypes.INTEGER, NUMBERS);

        MAP.put(ActionSpecTypes.ATOM, ATOMS);
        MAP.put(ActionSpecTypes.VARIABLE, VARIABLES);
        MAP.put(ActionSpecTypes.LINE_COMMENT, COMMENTS);
